		...
		btnCancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ctrl.cancelAppointment(p, p.getDni_patient());

					tableModel.open();
					calendarPanel1.open(tableModel.getAppointments());

					JOptionPane.showMessageDialog(SwingUtilities.getWindowAncestor(AppointmentsPanel.this), "The appointment has been cancelled", "", JOptionPane.INFORMATION_MESSAGE);
