...
public class DoctorRegisterApplicationPanel extends JPanel {
	...
	private DoctorRegisterApplicationModel tableModel;

	/**
	 * Creates new form DoctorChangeRequestAproverPanel
	 */
	private DoctorRegisterApplicationPanel(Controller ctrl) {
		this.ctrl = ctrl;
		tableModel = new DoctorRegisterApplicationModel(ctrl);
		initComponents();
	}

	// Singleton
	public static DoctorRegisterApplicationPanel getInstance(Controller ctrl) {
		if (instance == null)
			instance = new DoctorRegisterApplicationPanel(ctrl);
		instance.open();
	...
	private void initComponents() {
		...
		titleLabel.setText("Doctor application requests");
	...
	private void addActionListenerActionPerformed(ActionEvent e) {
		try {
			...
			DoctorRegisterApplication req = tableModel.getRequest(row);

			ctrl.denyDoctorApplication(req);
	...
	private void aproveButtonActionPerformed(ActionEvent e) {
		try {
			...
			ctrl.aceptDoctorApplication(req);
